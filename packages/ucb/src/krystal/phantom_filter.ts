 ...
 * Перенесено ДОСЛОВНО из apps/web/src/lib/krystal/phantom_filter.ts (порт
 * V3-операций в серверный движок, 2026-06-12) — web теперь re-export отсюда.
 */
import type { KrystalV3Summary } from "./adapter.js";
