...
// v2: NonLpOpener расширен openedInTokens + startUsd (Stage 2a). v1 entries
// без этих полей → bump чтобы refetch с OUT-side данными.
const CACHE_KEY = "capflow.cache.nonlp.opener.v2";
